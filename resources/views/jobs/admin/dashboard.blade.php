<x-guest-layout>
    <div class="flex min-h-screen w-full">
        <aside x-bind:class="translate-x-full lg:translate-x-0 rtl:lg:-translate-x-0 rtl:translate-x-full" class="fixed inset-y-0 left-0 rtl:left-auto rtl:right-0 z-20 flex flex-col h-screen overflow-hidden shadow-2xl transition-all bg-white filament-sidebar lg:border-r w-80 lg:z-0 lg:translate-x-0 dark:bg-gray-800 dark:border-gray-700 -translate-x-full rtl:lg:-translate-x-0 rtl:translate-x-full">
