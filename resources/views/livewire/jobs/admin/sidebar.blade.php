<div class="w-full">
    <header class="border-b h-[4rem] shrink-0 px-6 flex items-center filament-sidebar-header dark:border-gray-700">
        <a href="/">
            <svg role="img" aria-label="Filament" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 303 61"
    ...
    <nav class="flex-1 overflow-y-auto py-6 filament-sidebar-nav">
        <ul class="space-y-6 px-6">
            <li x-data="{ label: & quot; & quot; }" class="filament-sidebar-group">
                <ul x-collapse.duration.200ms="" class="text-sm space-y-1">
                    <li class="filament-sidebar-item">
                        <a href="https://demo.filamentphp.com"
                            x-on:click="window.matchMedia(`(max-width: 1024px)`).matches &amp;&amp; $store.sidebar.close()"
                            class="flex items-center gap-3 px-3 py-2 rounded-lg font-medium transition hover:bg-gray-500/5 focus:bg-gray-500/5 dark:text-gray-300 dark:hover:bg-gray-700">
                    ...
                    <li x-data='{ label: "Shop" }' class="filament-sidebar-group">
                        <button x-on:click.prevent="$store.sidebar.toggleCollapsedGroup(label)"
                            ...
                            <svg class="w-3 h-3 text-gray-600 dark:text-gray-300" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <ul x-collapse.duration.200ms="" class="text-sm space-y-1 -mx-3 mt-2">
                            <li class="filament-sidebar-item">
                            ...
                            <li class="filament-sidebar-item">
                                <a href="https://demo.filamentphp.com/shop/discounts"
                                    x-on:click="window.matchMedia(`(max-width: 1024px)`).matches &amp;&amp; $store.sidebar.close()"
                                    class="flex items-center gap-3 px-3 py-2 rounded-lg font-medium transition hover:bg-gray-500/5 focus:bg-gray-500/5 dark:text-gray-300 dark:hover:bg-gray-700">
                                    <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                            ...
                            <li class="filament-sidebar-item">
                                <a href="https://demo.filamentphp.com/shop/reviews"
                                    x-on:click="window.matchMedia(`(max-width: 1024px)`).matches &amp;&amp; $store.sidebar.close()"
                                    class="flex items-center gap-3 px-3 py-2 rounded-lg font-medium transition hover:bg-gray-500/5 focus:bg-gray-500/5 dark:text-gray-300 dark:hover:bg-gray-700">
                                    <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
